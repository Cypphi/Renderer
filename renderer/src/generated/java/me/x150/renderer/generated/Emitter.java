...
/**
 * This class was autogenerated from the descriptor file: /home/cypphi/Projects/Renderer/emitterSpec.json5.
...
public final class Emitter {
  ...
  public static void _emit_line__2xposition_color_normal_lineWidth(final Matrix4f positionTransform,
      final Matrix3f normalTransform, final VertexConsumer consumer, float v0_position_x,
      float v0_position_y, float v0_position_z, float v0_color_r, float v0_color_g,
      float v0_color_b, float v0_color_a, float v0_normal_nx, float v0_normal_ny,
      float v0_normal_nz, float v0_lineWidth_width, float v1_position_x, float v1_position_y,
      float v1_position_z, float v1_color_r, float v1_color_g, float v1_color_b, float v1_color_a,
      float v1_normal_nx, float v1_normal_ny, float v1_normal_nz, float v1_lineWidth_width) {
    Vector3f transformed = new Vector3f();
    positionTransform.transformPosition(v0_position_x, v0_position_y, v0_position_z, transformed);
    v0_position_x = transformed.x;
    v0_position_y = transformed.y;
    ...
    {
      // Vertices: 0-1
      consumer.vertex(v0_position_x, v0_position_y, v0_position_z).color(v0_color_r, v0_color_g, v0_color_b, v0_color_a).normal(v0_normal_nx, v0_normal_ny, v0_normal_nz).lineWidth(v0_lineWidth_width);
      consumer.vertex(v1_position_x, v1_position_y, v1_position_z).color(v1_color_r, v1_color_g, v1_color_b, v1_color_a).normal(v1_normal_nx, v1_normal_ny, v1_normal_nz).lineWidth(v1_lineWidth_width);
    }
  }
}
